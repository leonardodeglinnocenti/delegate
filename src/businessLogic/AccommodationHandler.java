...
public class AccommodationHandler {
    ...
    public Accommodation createAccommodation(String type, String description, int maxGuestsAllowed) throws Exception {
        if (type.equals("apartment")) {
            ...
            try {
                ...
                throw new Exception("ERROR: Could not insert apartment.", e);
            }
            ...
            try {
                ...
                throw new Exception("ERROR: Could not insert room.", e);
            }
